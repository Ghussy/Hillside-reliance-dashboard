  ...
  sections: [
    {
      title: 'Overview',
      description:
        'The Workspaces page allows you to manage your workspaces. This feature will be expanded in the future to support multi-tenant workspace management.',
      links: [
        {
    ...
    },
    {
      ...
      description:
        'Workspace and organization features are planned for a future release. Currently, all authenticated users have access to the dashboard.',
      links: []
    }
  ]
};
  ...
  sections: [
    {
      title: 'Overview',
      description:
        'The Team Management page will allow you to manage your workspace team, including members, roles, and permissions. This feature is planned for a future release.',
      links: [
        {
  ...
  sections: [
    {
      title: 'Overview',
      description:
        'The Billing page will allow you to manage subscription plans. This feature is planned for a future release.',
      links: []
    }
  ]
};
